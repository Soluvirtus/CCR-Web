function initializeNavbarScripts(){document.addEventListener("scroll",function(){var e=document.querySelector(".navbar");e&&(0<window.scrollY?e.classList.add("scrolled-navbar"):e.classList.remove("scrolled-navbar"))});var e=document.getElementById("theme-toggle"),a=document.getElementById("theme-toggle-mobile");e&&e.addEventListener("click",()=>{updateTheme()}),a&&a.addEventListener("click",()=>{updateTheme()}),updateTheme(!0)}function updateTheme(e=!1){var a=document.body;let o;(o=e?"dark"===localStorage.getItem("theme"):!a.classList.contains("dark-mode"))?(a.classList.add("dark-mode"),localStorage.setItem("theme","dark")):(a.classList.remove("dark-mode"),localStorage.setItem("theme","light"));e=document.getElementById("theme-icon"),a=document.getElementById("theme-icon-mobile");e&&(o?e.classList.replace("bi-sun-fill","bi-moon-fill"):e.classList.replace("bi-moon-fill","bi-sun-fill")),a&&(o?a.classList.replace("bi-sun-fill","bi-moon-fill"):a.classList.replace("bi-moon-fill","bi-sun-fill"))}document.addEventListener("DOMContentLoaded",function(){fetch("nav.html").then(e=>{if(e.ok)return e.text();throw new Error("Network response was not ok "+e.statusText)}).then(e=>{var a=document.getElementById("navbar-placeholder");a&&(a.innerHTML=e),initializeNavbarScripts()}).catch(e=>{console.error("Hubo un problema al cargar la barra de navegación:",e)});let o=["assets/img/slideshow/ccr1.jpeg","assets/img/slideshow/IMG_1919.webp","assets/img/slideshow/IMG_0257.webp","assets/img/slideshow/IMG_0499.webp"],s=0;var e=document.querySelector(".bgimg-1");let n=e?e.querySelector(".layer-1"):null,r=e?e.querySelector(".layer-2"):null;e&&n&&r&&(n.style.backgroundImage=`url(${o[0]})`,n.classList.add("active"),setInterval(function(){var e=s,a=(s=(s+1)%o.length,e%2==0?n:r);(e=e%2==0?r:n).style.backgroundImage=`url(${o[s]})`,a.classList.remove("active"),e.classList.add("active")},5e3));let i=document.querySelector("#imageCarousel .carousel-inner");i&&["assets/img/slideshow/tabasco.jpg","assets/img/slideshow/ccr_ppll.jpg","assets/img/slideshow/cccr_sola_scriptura.jpg","assets/img/slideshow/ccr_navidad.jpg","assets/img/slideshow/ccr_cena.jpg","assets/img/slideshow/ccr_entrance.jpg","assets/img/slideshow/unnamed.jpg","assets/img/slideshow/ccr1.jpeg","assets/img/slideshow/IMG_2305.webp","assets/img/slideshow/IMG_2269.webp","assets/img/slideshow/IMG_1971.webp","assets/img/slideshow/IMG_1919.webp","assets/img/slideshow/IMG_1687.webp","assets/img/slideshow/IMG_1604.webp","assets/img/slideshow/IMG_1598.webp","assets/img/slideshow/IMG_0292.webp","assets/img/slideshow/IMG_0257.webp","assets/img/slideshow/IMG_0292.webp"].forEach((e,a)=>{var o=document.createElement("div"),a=(o.classList.add("carousel-item"),0===a&&o.classList.add("active"),document.createElement("img"));a.src=e,a.classList.add("d-block","w-100"),a.alt="...",a.loading="lazy",o.appendChild(a),i.appendChild(o)});e=document.querySelector("#historiaBtn");e&&e.addEventListener("click",function(e){e.preventDefault();e=document.getElementById("flashNotification");e&&new bootstrap.Toast(e,{delay:2e3}).show()});let l=document.querySelector("form");l&&l.addEventListener("submit",e=>{let a=document.querySelector(".contact-form-loader"),o=document.querySelector(".contact-form-response"),s=document.querySelector("#formButton");a&&a.classList.remove("none"),s&&s.setAttribute("disabled",""),setTimeout(()=>{a&&a.classList.add("none"),o&&o.classList.remove("none"),l.reset(),s&&s.removeAttribute("disabled"),setTimeout(()=>{o&&o.classList.add("none")},5e3)},3e3)}),"/links"===window.location.pathname&&window.location.replace("/linktree.html");for(let e=1;e<=13;e++){var a,d=document.querySelector(`#transcripcion${e} .transcripcion-contenido`);d&&(a="leccion"+e,"undefined"!=typeof transcripciones&&transcripciones[a]?(a=transcripciones[a].split("\n\n").map(e=>`<p>${e.trim()}</p>`).join(""),d.innerHTML=a):d.innerHTML="<p>Transcripción no disponible por el momento.</p>")}}),window.openImageModal=function(e){var s=document.getElementById("modalImage");if(s){s.src=e;let a=new bootstrap.Modal(document.getElementById("imageModal")),o=document.querySelector(".modal-body");o&&o.addEventListener("click",function(e){e.target===o&&a.hide()}),a.show()}},window.addEventListener("load",()=>updateTheme(!0)),document.addEventListener("DOMContentLoaded",()=>{document.querySelectorAll(".link").forEach(e=>{e.addEventListener("click",()=>{var e=document.getElementById("linkSound");e.currentTime=0,e.play()})})}),document.addEventListener("DOMContentLoaded",()=>{let i=[],l=new Set,s="ccrFundamentosProgress",d="ccrFundamentosLastLesson",a=1.1,o=document.getElementById("lesson-list-container"),u=document.querySelector("#lesson-content .lesson-body"),t=document.querySelector("#lesson-content .initial-message"),n=document.getElementById("transcriptModalLabel"),r=document.querySelector("#transcript-modal .modal-body .transcripcion-contenido");var e=document.getElementById("transcript-modal");let c=document.getElementById("increase-font"),m=document.getElementById("decrease-font");var p=document.getElementById("reset-font");function q(e){var a,o;"introduccion"!==i[e].id&&(l.has(e)?l.delete(e):l.add(e),localStorage.setItem(s,JSON.stringify([...l])),e=e,a=document.querySelector(`.lesson-list-item[data-lesson-index="${e}"]`),o=document.getElementById("progress-toggle-btn"),l.has(e)?(a?.classList.add("completed"),o&&(o.classList.remove("btn-outline-primary"),o.classList.add("btn-success"),o.innerHTML='<i class="bi bi-check-circle-fill"></i> Lección Completada')):(a?.classList.remove("completed"),o&&(o.classList.remove("btn-success"),o.classList.add("btn-outline-primary"),o.innerHTML="Marcar como completada")))}function b(a){var o=i[a];if(o){t.style.display="none",localStorage.setItem(d,a);let e="";e="introduccion"===o.id?(r=o.content.replace(/\n/g,"<br>"),`
            <h2>${o.title}</h2>
            <hr>
            <div class="introduction-content">${r}</div>
          ...
          `):(r=o.references.map(e=>`
            <a href="${e.link}" target="_blank" class="btn btn-sm btn-outline-secondary me-2 mb-2">
              ${e.text}
            </a>
          `).join(""),n=`
            <div class="text-start my-4">
              <button class="btn btn-outline-primary mb-3" type="button" data-bs-toggle="modal" data-bs-target="#transcript-modal" data-lesson-index="${a}">
          ...
          `,s=l.has(a),`
            <h2>${o.title}</h2>
            <hr>
            <iframe style="border-radius:12px; margin-bottom:1rem;" src="${o.spotifyLink}" width="100%" height="152" frameBorder="0" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
            ${n}
            ...
            ${`
              ...
              <div class="text-center mt-3 mb-3">
                  <button class="btn ${s?"btn-success":"btn-outline-primary"}" id="progress-toggle-btn">
                      ${s?'<i class="bi bi-check-circle-fill"></i> Lección Completada':"Marcar como completada"}
                  </button>
              </div>
          `}
          `);var s,n=0===a?"disabled":"",r=`
          <hr class="my-4">
          <div class="lesson-navigation">
            <button class="btn btn-outline-secondary" id="prev-lesson-btn" ${n}>
              <i class="bi bi-arrow-left"></i> Anterior
            </button>
            <button class="btn btn-outline-secondary" id="next-lesson-btn" ${a===i.length-1?"disabled":""}>
              Siguiente <i class="bi bi-arrow-right"></i>
            </button>
          </div>
        `;u.innerHTML=e,u.insertAdjacentHTML("beforeend",r),"introduccion"!==o.id&&document.getElementById("progress-toggle-btn").addEventListener("click",()=>q(a)),document.getElementById("prev-lesson-btn").addEventListener("click",()=>b(a-1)),document.getElementById("next-lesson-btn").addEventListener("click",()=>b(a+1)),document.querySelectorAll(".lesson-list-item a").forEach(e=>e.classList.remove("active")),document.querySelector(`.lesson-list-item a[data-index="${a}"]`)?.classList.add("active")}}e.addEventListener("show.bs.modal",function(e){e=e.relatedTarget.getAttribute("data-lesson-index"),e=i[e];n.textContent="Transcripción: "+e.title;e=(window.transcripcionesData[e.transcriptKey]||"").split(/\n\s*\n/).map(e=>e.trim()).filter(e=>0<e.length).map(e=>`<p>${e.replace(/\n/g,"<br>")}</p>`).join("");r.innerHTML=e,a=1.1,h()}),fetch("assets/clases.json").then(e=>e.json()).then(e=>{i=e,(e=localStorage.getItem(s))&&(l=new Set(JSON.parse(e))),o.innerHTML=i.map((e,a)=>`
            <li class="lesson-list-item ${l.has(a)?"completed":""}" data-lesson-index="${a}">
              <a href="#" data-index="${a}">
                <span class="lesson-title">${"introduccion"===e.id?`<strong>${e.title}</strong>`:`<strong>Lección ${e.lessonNumber}:</strong> `+e.title}</span>
                ${"introduccion"!==e.id?'<i class="bi bi-check-circle-fill completion-icon"></i>':""}
              </a>
            </li>
          `).join(""),document.querySelectorAll(".lesson-list-item a").forEach(e=>{e.addEventListener("click",e=>{e.preventDefault(),b(parseInt(e.currentTarget.getAttribute("data-index")))})});e=localStorage.getItem(d);null!==e&&i[parseInt(e,10)]?b(parseInt(e,10)):b(0)}).catch(e=>{console.error("Error al cargar las lecciones:",e),o.innerHTML='<p class="text-danger">No se pudo cargar el temario.</p>'});let v=document.querySelector("#transcript-modal .modal-body"),g=document.getElementById("back-to-top");function h(){r.style.fontSize=a+"rem",m.disabled=a.toFixed(1)<=.8,c.disabled=1.8<=a.toFixed(1)}c.addEventListener("click",()=>{a<1.8&&(a+=.1,h())}),m.addEventListener("click",()=>{.8<a&&(a-=.1,h())}),p.addEventListener("click",()=>{a=1.1,h()}),v.addEventListener("scroll",()=>{200<v.scrollTop?g.style.display="block":g.style.display="none"}),g.addEventListener("click",()=>{v.scrollTo({top:0,behavior:"smooth"})});e=document.getElementById("mobile-menu-toggle");let y=document.getElementById("lesson-sidebar");e.addEventListener("click",()=>{y.classList.toggle("show")}),y.addEventListener("click",e=>{e.target.closest("a")&&window.innerWidth<768&&y.classList.remove("show")})});let transcripcionesData={leccion1:`Como punto de inicio de nuestro mensaje esta mañana quisiera compartir con ustedes 2 Timoteo capítulo 3, que será el punto de partida basado en lo que este texto afirma.
